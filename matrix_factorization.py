...
def low_rank_matrix_factorization(ratings, mask=None, num_features=5, regularization_amount=0.01):
    ...
    X = fmin_cg(cost, initial, fprime=gradient, args=args, maxiter=100)
